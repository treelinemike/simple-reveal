...
icData = {};
icData{end+1} = [ekf1.estError ekfp1.estError(:,2) eif1.estError(:,2)];
icData{end+1} = [ekf2.estError ekfp2.estError(:,2) eif2.estError(:,2)];
icData{end+1} = [ekf3.estError ekfp3.estError(:,2) eif3.estError(:,2)];
...
legend('EKF','EKF w/ Projection','EIF','Location','northwest');
